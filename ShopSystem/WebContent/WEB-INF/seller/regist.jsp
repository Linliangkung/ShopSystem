		...
		<div class="span24">
			<div class="wrap">
				<div class="main clearfix">
					<div class="title">
						<strong>商家注册</strong>SELLER REGISTER
					</div>
					<form id="registerForm"  method="post" action="${pageContext.request.contextPath}/seller/seller_regist.action">
						<table>
							<tbody><tr>
								<th>
									<span class="requiredField">*</span>账&nbsp;&nbsp;号:
								</th>
								<td>
									<input type="text" id="username" name="saccount" class="text" maxlength="20" value="<s:property value="saccount"/>" /> <label class="error"><s:property value="fieldErrors.saccount[0]"/></label>
								</td>
							</tr>
							<tr>
								<th>
								...
								<td>
									<input type="password" id="password" name="spassword" class="text" maxlength="20" autocomplete="off"> 
								</td>
							</tr>
							<tr>
								<th>
								...
								<td>
									<input type="text" id="phone" name="sphone" class="text" value="<s:property value="sphone"/>" maxlength="200" /> 
								</td>
							</tr>
									...
									<tr>
										...
										<td>
												<input type="text" id="name" name="sname" class="text" value="<s:property value="sname"/>" maxlength="200" > 
										</td>
									</tr>
									<tr>
										<th>
										...
										<td>
												<textarea  style="vertical-align: middle; color: black" cols="30" rows="3" name="sdesc" id="addr"  ><s:property value="sdesc"/></textarea>  
										</td>
									</tr>
							<tr>
								<th>&nbsp;
