...
<div class="dtree">
	...
	<script type="text/javascript">
		...
		d=new dTree('d');
		d.add('01',-1,'系统菜单树');
		d.add('0101','01','一级分类管理','${pageContext.request.contextPath}/admin/adminHome_welcomePage.action','','mainFrame');
		d.add('010101','0101','一级分类管理','${pageContext.request.contextPath}/admin/adminCategory_listCategoryPage.action','','mainFrame');
		d.add('0102','01','二级分类管理','${pageContext.request.contextPath}/admin/adminHome_welcomePage.action','','mainFrame');
		d.add('010201','0102','二级分类管理','${pageContext.request.contextPath}/admin/adminCategorySecond_listCategorySecondPage.action?page=1','','mainFrame');
		d.add('0103','01','热门商品管理','${pageContext.request.contextPath}/admin/adminHome_welcomePage.action','','mainFrame');
		d.add('010301','0103','热门商品管理','${pageContext.request.contextPath}/admin/adminProduct_listProductPage.action?page=1','','mainFrame');
		document.write(d);
	</script>
</div>	</td>
  </tr>
