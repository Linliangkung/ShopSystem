...
<script type="text/javascript">
	...
	window.onload=function(){
		if(window.parent!=window){
			window.parent.location.href="${pageContext.request.contextPath}/admin/admin_loginPage.action"
		}
		...
		<div class="span12 last">
			<div class="wrap">
				<div class="main">
					...
					<form id="loginForm"  method="post" action="${pageContext.request.contextPath }/admin/admin_login.action">
						<table>
							<tbody><tr>
								<th>
										账&nbsp;&nbsp;号:
								...
								<td>
									<input type="text" id="username" name="aaccount" class="text" maxlength="20" value="${param.aaccount}"> <label class="error"><s:property value="fieldErrors.username[0]"/> </label> 
								</td>
							</tr>
							<tr>
								<th>
								...
								<td>
									<input type="password" id="password" name="apassword" class="text" maxlength="20" autocomplete="off"><label class="error"><s:property value="fieldErrors.password[0]"/> </label> 
								</td>
