...
<div class="container cart">
		...
		<div class="span24">
			...
			<div class="step step1">
				...
				订单号: <strong id="effectivePrice"><s:property value="#order.oid"/> </strong><br/>
				下单时间:<strong id="effectivePrice"><s:date name="#order.ordertime" format="yyyy-MM-dd HH:mm:ss" /></strong><br/>
				<table>
					<tbody>
					<tr>
						<th>图片</th>
					...
					<s:iterator value="#order.orderItems">
						<tr>
							...
							<td class="quantity" width="60">
								<input type="text" name="count" value="<s:property value="quantity"/>" maxlength="4" onpaste="return false;" readonly="readonly"/>
							</td>
							<td width="140">
			...
			<form id="orderForm" action="${pageContext.request.contextPath }/order_payOrder" method="post">
				...
				<div class="span24">
					<p>
							收货地址：<input name="addr" type="text" value="<s:property value="#order.addr"/>" style="width:350px" />
								<br />
							收货人&nbsp;&nbsp;&nbsp;：<input name="consignee" type="text" value="<s:property value="#order.consignee"/>" style="width:150px" />
								<br /> 
							联系方式：<input name="phone" type="text"value="<s:property value="#order.phone"/>" style="width:150px" />
